...
const en = {
  ...
  account: {
    ...
    webLoginHint: 'Authorize a sign-in on the web — scan the QR or enter the code shown in the browser.',
    scanQr: 'Scan QR',
...
const cs: T = {
  ...
  account: {
    ...
    webLoginHint: 'Autorizuj přihlášení na webu — naskenuj QR nebo zadej kód z prohlížeče.',
    scanQr: 'Skenovat QR',
    code: 'Kód z webu',
    approve: 'Schválit',
    approving: 'Schvaluji…',
